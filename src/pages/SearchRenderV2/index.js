        ...
        return (
            <React.Fragment>
                <div
                    ...
                    style={{ display: visible ? 'block' : 'none', top: expand ? '120px' : '37px' }}
                >
                    <div className='drawer-header'>
                        <span className='drawer-title'>导航</span>
                        <Icon type="close" style={{cursor: 'pointer'}} onClick={() => {this.props.handleState('searchDrawerVisible', false) }} />
                    </div>
                    ...
                    <Tabs activeKey={this.state.activeKey} onChange={this.onChange}>
                        ...
                        {
                            (this.props.recordId !== '' && this.props.recordId !== 'undefined') ?
                                <TabPane
                                    tab={
                                        <span>
                                            <Icon type="carry-out" />

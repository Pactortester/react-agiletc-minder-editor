/*!
 * ====================================================
 * Kity Minder Core - v1.4.50 - 2022-03-09
...
(function () {
  ...
  _p[28] = {
    value: function (require, exports, module) {
      ...
      kity.extendClass(Minder, {
         ...
         * @returns
         */
        selectSibling: function (node) {
          var siblingNodes = node.getSiblings();
          siblingNodes.push(node);
          return this.select(siblingNodes, false);
        },
          ...
          execute: function (km, progress) {
            ...
            function updateNodeExpandState(node, state) {
              if (
                !(
                  state === STATE_EXPAND &&
                  typeof node.getData(EXPAND_STATE_DATA) === "undefined"
                )
              ) {
  ...
  _p[49] = {
    value: function (require, exports, module) {
      ...
      var Module = _p.r(20);
      var Renderer = _p.r(27);
      Module.register("ImageResizerModule", function () {
        var minder = this;
        // minder.getPaper().addResource(FRAME_GRAD);
        // 进度图标的图形
        var ImageResizer = kity.createClass("ImageResizer", {
          base: kity.Group,
          constructor: function (value) {
            ...
            this.create();
            this.setValue(value);
            this.setId(utils.uuid("node_image_resizer"));
          ...
          create: function () {
            var default_circle = new kity.Circle(9)
              .fill("#1296db")
              .setOpacity(0.1);
            // question = new kity.Path().setTranslate( - 10, -10).setScale(.02).setPathData("M524.8 620.8h-89.6v-32c0-25.6 3.2-44.8 12.8-60.8 9.6-16 22.4-35.2 44.8-51.2 22.4-19.2 38.4-35.2 48-48 6.4-12.8 12.8-25.6 12.8-41.6s-6.4-28.8-16-38.4c-12.8-9.6-28.8-16-51.2-16-41.6 0-80 16-118.4 48V275.2c41.6-22.4 83.2-35.2 128-35.2 51.2 0 92.8 12.8 118.4 35.2 28.8 22.4 41.6 54.4 41.6 96 0 25.6-6.4 51.2-16 70.4-12.8 22.4-32 44.8-60.8 67.2-25.6 19.2-38.4 35.2-44.8 44.8-6.4 9.6-9.6 22.4-9.6 38.4v28.8zM480 668.8c16 0 32 6.4 44.8 16s19.2 25.6 19.2 41.6-6.4 28.8-19.2 38.4c-12.8 9.6-25.6 16-44.8 16-16 0-32-6.4-44.8-16s-19.2-25.6-19.2-38.4c0-16 6.4-28.8 19.2-38.4s28.8-19.2 44.8-19.2z").fill("#EEE")
            // star = new kity.Path().setTranslate(-10, -10).setScale(.02).setPathData("M575.852903 115.426402L661.092435 288.054362c10.130509 20.465674 29.675227 34.689317 52.289797 37.963825l190.433097 27.62866c56.996902 8.288598 79.7138 78.281203 38.475467 118.496253l-137.836314 134.35715c-16.372539 15.963226-23.84251 38.987109-19.954032 61.49935l32.540421 189.716799c9.721195 56.792245-49.833916 100.077146-100.793444 73.267113L545.870691 841.446188a69.491196 69.491196 0 0 0-64.67153 0l-170.376737 89.537324c-50.959528 26.810033-110.51464-16.474868-100.793444-73.267113L242.569401 667.9996c3.888478-22.512241-3.581493-45.536125-19.954032-61.49935L84.779055 472.245428c-41.238333-40.215049-18.521435-110.207655 38.475467-118.496252l190.433097-27.62866c22.61457-3.274508 42.159288-17.498151 52.289797-37.963826L451.319277 115.426402c25.479764-51.675827 99.053862-51.675827 124.533626 0z").fill("#d4237a")
            // edit = new kity.Path().setTranslate(-10, -10).setScale(.02).setPathData("M883.626667 300.373333a42.666667 42.666667 0 0 0 0-60.16l-99.84-99.84a42.666667 42.666667 0 0 0-60.16 0l-78.506667 78.08 160 160M128 736V896h160L759.893333 423.68l-160-160L128 736z").fill("#1afa29")
            // stop = new kity.Path().setTranslate(-10, -10).setScale(.02).setPathData("M512 0a512 512 0 0 1 512 512 512 512 0 1 1-512-512z m-64 320h-128v384h128v-384z m256 0h-128v384h128v-384z").fill("#d81e06")
            this.addShapes([default_circle]);
          },
          setValue: function (value) {},
        });
        return {
          renderers: {
            bottom: kity.createClass("ImageResizer", {
              base: Renderer,
              create: function (node) {
                var imageResizer = new ImageResizer();
                imageResizer.setStyle("cursor", "se-resize");
              ...
              update: function (icon, node, box) {
                ...
                var x = box.cx - size.width / 2 + size.width;
                var y = box.y - spaceTop + size.height;
  ...
  _p[55] = {
    value: function (require, exports, module) {
      ...
      var Module = _p.r(20);
      var Renderer = _p.r(27);
      Module.register("NodeLinkModule", function () {
        var minder = this;
        var RESULT_DATA = "nodeLink";
        //
        // minder.getPaper().addResource(FRAME_GRAD);
        var NodeLInkIcon = kity.createClass("NodeLinkIcon", {
          ...
          create: function () {
            var default_circle = new kity.Circle(9)
              .fill("#FFED83")
              .setOpacity(0.1);
            nodeLink = new kity.Path()
              .setTranslate(-10, -10)
              .setScale(0.02)
              .setPathData(
                "M307.2 307.2a204.8 204.8 0 0 0 0 409.6h102.4a34.133333 34.133333 0 1 1 0 68.266667H307.2A273.066667 273.066667 0 1 1 307.2 238.933333h102.4a34.133333 34.133333 0 1 1 0 68.266667H307.2z m273.066667-34.133333a34.133333 34.133333 0 0 1 34.133333-34.133334h102.4a273.066667 273.066667 0 1 1 0 546.133334h-102.4a34.133333 34.133333 0 1 1 0-68.266667h102.4a204.8 204.8 0 0 0 0-409.6h-102.4a34.133333 34.133333 0 0 1-34.133333-34.133333z m-307.2 238.933333a34.133333 34.133333 0 0 1 34.133333-34.133333h409.6a34.133333 34.133333 0 1 1 0 68.266666H307.2a34.133333 34.133333 0 0 1-34.133333-34.133333z"
              )
              .fill("#666");
         ...
         *   -1: 当前没有选中的节点
         */
        var NodeLinkCommand = kity.createClass("NodeLinkCommand", {
          base: Command,
          execute: function (km, value) {
            var nodes = km.getSelectedNodes();
            nodes.forEach(function (n) {
              n.setData("nodeLink", value);
              n.render();
            });
            km.layout();
          },
          queryValue: function (km) {
            var node = km.getSelectedNode();
            return node && node.getData("nodeLink");
          },
          queryState: function (km) {
        ...
        return {
          commands: {
            nodeLink: NodeLinkCommand,
          },
          renderers: {
            left: kity.createClass("NodeLinkRenderer", {
              base: Renderer,
              create: function (node) {
                ...
                nodeIcon.on("click", function () {
                  ...
                  var nodes = window.minder.getNodesById(
                    node.getData().nodeLink
                  );
                  if (nodes !== null && nodes.length !== 0) {
                    window.minder.execCommand("Camera", nodes[0], 0);
                    if (!nodes[0].isExpanded())
                      window.minder.execCommand("Expand", true);
                  }
                });
                return nodeIcon;
              },
              shouldRender: function (node) {
                return node.getData("nodeLink");
              },
              update: function (icon, node, box) {
                var data = node.getData("nodeLink");
                var spaceRight = node.getStyle("space-right");
                var x, y;
                icon.setValue(data);
                x = box.right + spaceRight;
  ...
  _p[57] = {
    value: function (require, exports, module) {
      ...
      var Module = _p.r(20);
      var Renderer = _p.r(27);
      Module.register("OtherModule", function () {
        var minder = this;
        var RESULT_DATA = "other";
        ...
        // minder.getPaper().addResource(FRAME_GRAD);
        // 进度图标的图形
        var OtherIcon = kity.createClass("OtherIcon", {
          base: kity.Group,
          constructor: function (value) {
            this.callBase();
            this.setSize(20);
            this.create();
            this.setValue(value);
            this.setId(utils.uuid("node_other"));
            this.translate(0.5, 0.5);
          },
          setSize: function (size) {
            this.width = this.height = size;
          ...
          create: function () {
            ...
            question = new kity.Path()
              .setTranslate(-10, -10)
              .setScale(0.02)
              .setPathData(
                "M524.8 620.8h-89.6v-32c0-25.6 3.2-44.8 12.8-60.8 9.6-16 22.4-35.2 44.8-51.2 22.4-19.2 38.4-35.2 48-48 6.4-12.8 12.8-25.6 12.8-41.6s-6.4-28.8-16-38.4c-12.8-9.6-28.8-16-51.2-16-41.6 0-80 16-118.4 48V275.2c41.6-22.4 83.2-35.2 128-35.2 51.2 0 92.8 12.8 118.4 35.2 28.8 22.4 41.6 54.4 41.6 96 0 25.6-6.4 51.2-16 70.4-12.8 22.4-32 44.8-60.8 67.2-25.6 19.2-38.4 35.2-44.8 44.8-6.4 9.6-9.6 22.4-9.6 38.4v28.8zM480 668.8c16 0 32 6.4 44.8 16s19.2 25.6 19.2 41.6-6.4 28.8-19.2 38.4c-12.8 9.6-25.6 16-44.8 16-16 0-32-6.4-44.8-16s-19.2-25.6-19.2-38.4c0-16 6.4-28.8 19.2-38.4s28.8-19.2 44.8-19.2z"
              )
              .fill("#EEE");
            star = new kity.Path()
              .setTranslate(-10, -10)
              .setScale(0.02)
              .setPathData(
                "M575.852903 115.426402L661.092435 288.054362c10.130509 20.465674 29.675227 34.689317 52.289797 37.963825l190.433097 27.62866c56.996902 8.288598 79.7138 78.281203 38.475467 118.496253l-137.836314 134.35715c-16.372539 15.963226-23.84251 38.987109-19.954032 61.49935l32.540421 189.716799c9.721195 56.792245-49.833916 100.077146-100.793444 73.267113L545.870691 841.446188a69.491196 69.491196 0 0 0-64.67153 0l-170.376737 89.537324c-50.959528 26.810033-110.51464-16.474868-100.793444-73.267113L242.569401 667.9996c3.888478-22.512241-3.581493-45.536125-19.954032-61.49935L84.779055 472.245428c-41.238333-40.215049-18.521435-110.207655 38.475467-118.496252l190.433097-27.62866c22.61457-3.274508 42.159288-17.498151 52.289797-37.963826L451.319277 115.426402c25.479764-51.675827 99.053862-51.675827 124.533626 0z"
              )
              .fill("#d4237a");
            edit = new kity.Path()
              .setTranslate(-10, -10)
              .setScale(0.02)
              .setPathData(
                "M883.626667 300.373333a42.666667 42.666667 0 0 0 0-60.16l-99.84-99.84a42.666667 42.666667 0 0 0-60.16 0l-78.506667 78.08 160 160M128 736V896h160L759.893333 423.68l-160-160L128 736z"
              )
              .fill("#1afa29");
            stop = new kity.Path()
              .setTranslate(-10, -10)
              .setScale(0.02)
              .setPathData(
                "M512 0a512 512 0 0 1 512 512 512 512 0 1 1-512-512z m-64 320h-128v384h128v-384z m256 0h-128v384h128v-384z"
              )
              .fill("#d81e06");
            this.addShapes([
              default_circle,
          ...
          setValue: function (value) {
            ...
            this.pie.setAngle(360).fill("#ff9800");
            this.question.setVisible(QUESTION_VALUE == value);
            this.pie.setVisible(QUESTION_VALUE === value);
            this.star.setVisible(STAR_VALUE == value);
            this.edit.setVisible(EDIT_VALUE == value);
            this.stop.setVisible(STOP_VALUE == value);
          },
        });
        /**
         * @command Result
         * @description 设置节点的图标信息（添加一个小图标）
         ...
         *   -1: 当前没有选中的节点
         */
        var OtherCommand = kity.createClass("OtherCommand", {
          base: Command,
          execute: function (km, value) {
            var nodes = km.getSelectedNodes();
            for (var i = 0; i < nodes.length; i++) {
        ...
        return {
          ...
          renderers: {
            left: kity.createClass("OtherRenderer", {
              base: Renderer,
              create: function (node) {
                return new OtherIcon();
              },
              shouldRender: function (node) {
          ...
          if (node.getLevel() > 1) {
            if (node.isSelected() || node.getData("image")) {
              ...
              outline
                ...
                .stroke("none", node.getStyle(prefix + "stroke-width"));
            }
          } else {
            outline
              .setPosition(outlineBox.x, outlineBox.y)
    ...
    value: function (require, exports, module) {
      ...
      Module.register("Resource", function () {
        ...
        var ResourceCommand = kity.createClass("ResourceCommand", {
          base: Command,
          execute: function (minder, resource, flag) {
            // flag 0  新增 ， 1 删除标签
            var nodes = minder.getSelectedNodes();
            var resourceName = "";
              ...
              if (flag === 0) {
                ...
                if (!nodeResource) {
                  ...
                  for (var i = 0; i < nodeResource.length; i++) {
                    if (
                      typeof nodeResource[i] === "string" &&
                      nodeResource[i] === resourceName
                    ) {
                      isMatch = true;
                      break;
                    }
                    if (
                      typeof nodeResource[i] === "object" &&
                      nodeResource[i].name === resourceName
                    ) {
                      isMatch = true;
                      break;
                    }
                  ...
                  if (!isMatch) {
                    nodeResource.push(resource);
                    node.setData("resource", nodeResource).render();
                  }
                }
              } else {
                if (nodeResource) {
                  nodeResource = nodeResource.filter(function (item) {
            ...
            nodes.forEach(function (node) {
              ...
              nodeResource.forEach(function (name) {
                ...
                if (typeof name === "string") {
                  ...
                  var result = resource.some(function (item) {
                    if (
                      item.name === name.name &&
                      item.bgColor === name.bgColor
                    )
                      return true;
                  });
                  if (!result) {
          ...
          update: function (container, node, box) {
            ...
            for (i = 0; i < resource.length; i++) {
              ...
              if (typeof resource[i] === "string") {
                ...
                overlay.setValue(resource[i].name, resource[i].bgColor);
              }
        ...
        return {
          ...
          events: {
            ...
            mouseup: function (e) {
              ...
              //去掉这块的逻辑，因为会导致，多选抬起的时候，选中变成一个的问题，暂时先不要，看下后续的影响
  ...
  _p[65] = {
    value: function (require, exports, module) {
      ...
      var TextCommand = kity.createClass({
        base: Command,
        execute: function (minder, text, nodeId) {
          var node =
            typeof nodeId === "undefined"
              ? minder.getSelectedNode()
              : minder.getNodeById(nodeId);
          if (node) {
            node.setText(text);
            node.render();
            minder.layout();
